...
<Step>
**Optional.** If you want C1 to manage the built-in Enterprise Owner role, install the app on the **enterprise account** as well, from your enterprise's **Settings** > **GitHub Apps**. Granting the enterprise permission above is not enough on its own: without that second installation the connector cannot read or assign owners.
</Step>
<Step>
...
stringData:
  ...
  BATON_ENTERPRISES: <Enterprise slug>
