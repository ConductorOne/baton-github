...
type GitHubEnterpriseUser struct {
	...
	GitHubComTwoFactorAuthRequiredByDate *time.Time `json:"github_com_two_factor_auth_required_by_date"`
	...
	GHELicenseStartDate                  *time.Time `json:"ghe_license_start_date"`
	GHELicenseEndDate                    *time.Time `json:"ghe_license_end_date"`
